...
int SetTempFiles(double set_time,void* set_value,short int data_type,unsigned int component_idx,Link* sys,unsigned int N,FILE* tempfile,GlobalVars* GlobalVars,unsigned int my_save_size,unsigned int** id_to_loc,DataTypes* dt_info);
